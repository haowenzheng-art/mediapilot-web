...
![MediaPilot Hero 首页](docs/screenshots/home.png)
...
写口播稿、剪短视频、做封面、配字幕——一年前还需要团队，现在一个人加一个 AI 就能干完。但门槛降低不是终点，而是新的起点：**当所有人都能把想法落地时，"被看见"就成了真正的瓶颈。**

做得出内容 ≠ 做得对内容。今天的胜负不在"产出能力"，而在"营销能力"——你能不能第一时间抓住正在上升的热点、用最短链路把它变成你的内容、再推到正确的平台上。

MediaPilot 干的就是这件事。它不替你思考，也不教你写作——它把从「发现机会」到「内容落地」的整条链路缩到几分钟：

- **看见**：全网五端热点扫描，按热度排序，今日徽章锁定上升期话题
- **落地**：选中热点一键生成口播文案和分镜头脚本，三平台 × 三风格
- **复盘**：所有产出自动入库，反查一条热点催生过哪些内容，看趋势曲线

每一步都有 AI 兜底，但每一步的判断权都在你手里。

把想法落地是 1，把它营销出去是后面的 0。MediaPilot 帮你把 0 接上。
